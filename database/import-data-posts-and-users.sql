...
INSERT INTO users (username, password_hash, full_name, email) VALUES ('admin', '$2y$10$QlKthcuYhn.XP/gy5A/OZeQdOzIznqxqOf/qBrSAnGpoW4labIL0W', '', 'admin@email.com');
INSERT INTO users (username, password_hash, full_name, email) VALUES ('nakov', '$2y$10$XViubT.zSoBtskZmKl6kdOX8Yq7T7tLrcrLn/5dkAqbgjVACeFUGe', 'Svetlin Nakov', 'nakov@email.com');
INSERT INTO users (username, password_hash, full_name, email) VALUES ('maria', '$2y$10$gzlpX/N5apTruTBajMJwM.0h9OgLVgQxk6N0YhGy2iY4BI73SYkKO', 'Maria Ivanova', 'ivanova@email.com');
INSERT INTO users (username, password_hash, full_name, email) VALUES ('ani', '$2y$10$9T9bN6ctJ4R.fdnLvzsdQOj0sk4mWqwohILMx60/jP1YEXtJguhD2', 'Ani Kirova', 'kirova@email.com');
INSERT INTO users (username, password_hash, full_name, email) VALUES ('joe', '$2y$10$aIOC0qiNK1mjZdUUbuj/Teh49VI/g9xanuWCNYEUruwcvOGVaXOGK', 'Joe Green', 'green@email.com');
INSERT INTO users (username, password_hash, full_name, email) VALUES ('test', '$2y$10$I5y7X1ZilitEZYOztOI5SuA2rBeRJUj/ZhlgmSZK32LPqaqh3Gy3q', '', 'test@email.com');
INSERT INTO users (username, password_hash, full_name, email) VALUES ('it''s security "test"<br>', '$2y$10$thSx6ceSyCPxdl.BDGLhKe7lQu8d3oopQ/LJYK8ma.Dz6jWbOgj8C', 'it''s security "test"<br>', 'test1@email.com');
INSERT INTO users (username, password_hash, full_name, email) VALUES ('vikash', '$2y$10$Exc5mMcThOlEnXZ2.kAPl.ouBSDl8S0GjD.3vvB6KohMpcgfsLsde', 'Vikash Jain', 'Jain@email.com');

INSERT INTO posts (title, content, date, user_id) VALUES ('Website Building', '<p>If the internet is a country, then websites are like real estates. I’m hoping by now you have a general understanding that real estates are valuable in the physical world – digital real estates work the same way. By building a website, you’re creating your own plot of online “land.”</p>
...
', '2016-05-20 11:18:26', 8);

INSERT INTO posts (title, content, date, user_id) VALUES ('Google Adsense', '<p>If that sounds like too much technical information for you, there is an easy button – Google’s advertising platform is as simple as signing up, enabling (on Blogger) or pasting a small code on your website, and allowing the advertisements to automatically roll in. The problem with this program is that you don’t get any commissions – and you don’t get to control the ad content. This is useful for some, but powerful users will want something a little more robust.</p>
', '2016-05-07 11:21:21', 3);

INSERT INTO posts (title, content, date, user_id) VALUES ('<p>Amazon Associates', 'Amazon has an Associates program for site owners and bloggers. They offer a search tool to find the right products and services from their site and a variety of ad styles to display on your site, including text-based and banner images (digital billboards) like this:<p>
...
INSERT INTO u_g_interaction (user_id, group_id) VALUES (1, 1);
INSERT INTO u_g_interaction (user_id, group_id) VALUES (2, 2);
INSERT INTO u_g_interaction (user_id, group_id) VALUES (3, 2);
INSERT INTO u_g_interaction (user_id, group_id) VALUES (4, 2);
