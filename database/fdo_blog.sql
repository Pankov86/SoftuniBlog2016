...
-- Dumping data for table fdo_blog.activity: ~7 rows (approximately)
...
INSERT INTO `deleted_posts` (`id`, `title`, `content`, `post_id`, `username`, `user_id`, `date_deleted`, `date_created`) VALUES
	(1, 'New post from roli', 'fgvhbjkl', 19, 'roli', 16, '2016-09-01 02:13:08', NULL);
...
-- Dumping data for table fdo_blog.posts: ~7 rows (approximately)
...
-- Dumping data for table fdo_blog.users: ~9 rows (approximately)
...
INSERT INTO `users` (`id`, `username`, `password_hash`, `full_name`, `email`, `About`) VALUES
	...
	(16, 'roli', '$2y$10$ULlKdCLKNJk0JoIsNSI7SeMNZ1RRjh.MhPUXpF92qP4H9n9.KfSM6', 'roli', 'roli@gmail.com', 'Awwww');
