...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2016 at 05:45 PM
...
INSERT INTO `category_post_interaction` (`id`, `category_id`, `post_id`) VALUES
(1, 1, 2),
(2, 1, 3),
(3, 1, 4),
(4, 2, 1),
...
--
-- AUTO_INCREMENT for table `category_post_interaction`
--
ALTER TABLE `category_post_interaction`
...
ALTER TABLE `posts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `post_tag_interaction`
--
ALTER TABLE `post_tag_interaction`
