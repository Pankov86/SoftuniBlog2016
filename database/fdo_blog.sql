...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2016 at 03:02 PM
...
--
-- Dumping data for table `category_post_interaction`
--
...
INSERT INTO `posts` (`id`, `title`, `content`, `date`, `user_id`, `views_count`, `points`) VALUES
...
--
-- Table structure for table `post_user_status`
--
...
ALTER TABLE `post_tag_interaction`
  ...
  ADD KEY `FK__tags` (`tag_id`);

--
-- Indexes for table `post_user_status`
--
ALTER TABLE `post_user_status`
  ADD PRIMARY KEY (`post_id`,`user_id`),
  ADD KEY `FK__users_status` (`user_id`);
...
ALTER TABLE `u_g_interaction`
  ...
  ADD KEY `FK_u_g_interaction_groups` (`group_id`);
...
--
ALTER TABLE `category_post_interaction`
  ADD CONSTRAINT `FK__category` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`),
...
--
ALTER TABLE `post_tag_interaction`
  ADD CONSTRAINT `FK__posts_tags` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`),
  ADD CONSTRAINT `FK__tags` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`id`);

--
-- Constraints for table `post_user_status`
--
ALTER TABLE `post_user_status`
  ADD CONSTRAINT `FK__posts_status` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`),
  ADD CONSTRAINT `FK__users_status` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `u_g_interaction`
--
ALTER TABLE `u_g_interaction`
  ADD CONSTRAINT `FK_u_g_interaction_groups` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`),
  ADD CONSTRAINT `FK_u_g_interaction_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
