...
-- Dumping data for table fdo_blog.comments: ~5 rows (approximately)
...
INSERT INTO `deleted_posts` (`id`, `post_title`, `post_content`, `author_name`, `author_email`, `date_deleted`, `reason_to_be_deleted`, `points`, `views_count`, `tag_id`, `category_id`) VALUES
	(13, 'Google Adsense', '<p>If that sounds like too much technical information for you, there is an easy button – Google’s advertising platform is as simple as signing up, enabling (on Blogger) or pasting a small code on your website, and allowing the advertisements to automatically roll in. The problem with this program is that you don’t get any commissions – and you don’t get to control the ad content. This is useful for some, but powerful users will want something a little more robust.</p>\n', 'maria', 'ivanova@email.com', '2016-08-30 17:12:45', 'User deleted', 0, 1, 0, 0);
...
-- Dumping data for table fdo_blog.post_tag_interaction: ~5 rows (approximately)
...
INSERT INTO `users` (`id`, `username`, `password_hash`, `full_name`, `email`, `About`) VALUES
	...
	(23, 'roli', '$2y$10$JO0IN1sdUdGTSswoqZcTDuifiSzmo14QyRvuxqtTqRvmS7w0xZsgy', 'roli', 'roli@gmail.com', 'fgh');
