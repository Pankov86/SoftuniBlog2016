...
INSERT INTO `posts` (`id`, `title`, `content`, `date`, `user_id`, `views_count`, `points`, `date_edited`) VALUES
	...
	(11, 'Sleep is for the weak', 'jhgjvykbhnjkm fghjkl;kjhg hgftjghjl', '2016-08-29 15:47:32', 1, 6, 1, '2016-08-31 13:24:08');
...
INSERT INTO `users` (`id`, `username`, `password_hash`, `full_name`, `email`, `About`) VALUES
	...
	(9, 'ralka', '$2y$10$8Y51RHnLsNy63nf36EnNEePDqleb.4fiEEUqCX6EZdwWODO1Tag32', 'Ралица', 'ralitza@start.bg', 'New about me info'),
