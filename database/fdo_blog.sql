...
-- Dumping data for table fdo_blog.activity: ~3 rows (approximately)
/*!40000 ALTER TABLE `activity` DISABLE KEYS */;
REPLACE INTO `activity` (`id`, `user_id`, `comments_count`, `points`, `points_given_by_user`, `Activitycol`) VALUES
	(1, 3, 4, 5, 1, NULL),
	(2, 2, 3, 1, 1, NULL),
...
-- Dumping data for table fdo_blog.category_post_interaction: ~10 rows (approximately)
/*!40000 ALTER TABLE `category_post_interaction` DISABLE KEYS */;
REPLACE INTO `category_post_interaction` (`post_id`, `category_id`) VALUES
	(1, 1),
	(2, 1),
	(3, 1),
	(4, 2),
...
-- Dumping data for table fdo_blog.comments: ~6 rows (approximately)
/*!40000 ALTER TABLE `comments` DISABLE KEYS */;
REPLACE INTO `comments` (`id`, `comment_body`, `author_id`, `post_id`, `date`) VALUES
...
REPLACE INTO `post_tag_interaction` (`post_id`, `tag_id`) VALUES
	(1, 5),
	(2, 3),
	(3, 4);
...
REPLACE INTO `tags` (`id`, `tag_name`) VALUES
	(5, '#blog'),
	(6, '#creativeWriting'),
	(3, '#development'),
	(4, '#digitalMarketing'),
...
REPLACE INTO `users` (`id`, `username`, `password_hash`, `full_name`, `email`, `About`) VALUES
...
-- Dumping data for table fdo_blog.u_g_interaction: ~9 rows (approximately)
/*!40000 ALTER TABLE `u_g_interaction` DISABLE KEYS */;
REPLACE INTO `u_g_interaction` (`user_id`, `group_id`) VALUES
	(1, 1),
	(2, 2),
	(3, 2),
	(4, 2),
